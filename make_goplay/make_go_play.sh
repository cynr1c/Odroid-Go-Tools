...
GOPLAY_SOURCE_PATH=~/Schreibtisch/odgo/super-go-play
PATH_ORIG=`pwd`
SERIAL_PORT="/dev/ttyUSB0"
GO_PLAY_ORIG_FW_PATH="Go-Play.fw"
EFWT_PATH="$PATH_ORIG/../efwt" 
MKFW_PATH="$PATH_ORIG/../../odroid-go-firmware/tools/mkfw"
...
cd $PATH_ORIG
$MKFW_PATH/mkfw Mega-Go-Play tile.raw 0 16 1048576 springboard springboard.bin 0 17 1048576 nesemu nesemu-go.bin 0 18 1048576 gnuboy gnuboy-go.bin 0 19 2097152 smsplusgx smsplusgx-go.bin
mv firmware.fw Mega-Go-Play.fw
